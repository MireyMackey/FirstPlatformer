...
public class Constants {
    ...
    public static class UIConstants{
        public static class Buttons{
            public static final float BUTTON_SCALE = 2f;
            ...
            public static final int BUTTON_WIDTH = (int)(BUTTON_DEFAULT_WIDTH * Game.getScale() / BUTTON_SCALE);
            public static final int BUTTON_HEIGHT = (int)(BUTTON_DEFAULT_HEIGHT * Game.getScale() / BUTTON_SCALE);
            public static final int BUTTON_BOUND_WIDTH = (int)(BUTTON_BOUND_DEFAULT_WIDTH * Game.getScale() / BUTTON_SCALE);
            public static final int BUTTON_BOUND_HEIGHT = (int)(BUTTON_BOUND_DEFAULT_HEIGHT * Game.getScale() / BUTTON_SCALE);
        }
